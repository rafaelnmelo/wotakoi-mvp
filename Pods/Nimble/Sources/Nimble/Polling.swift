...
extension SyncExpectation {
    ...
    @discardableResult
    @available(*, deprecated, message: "the sync version of `toEventually` does not work in async contexts. Use the async version with the same name as a drop-in replacement")
    ...
    @discardableResult
    @available(*, deprecated, message: "the sync version of `toEventuallyNot` does not work in async contexts. Use the async version with the same name as a drop-in replacement")
    ...
    @discardableResult
    @available(*, deprecated, message: "the sync version of `toNotEventually` does not work in async contexts. Use the async version with the same name as a drop-in replacement")
    ...
    @discardableResult
    @available(*, deprecated, message: "the sync version of `toNever` does not work in async contexts. Use the async version with the same name as a drop-in replacement")
    ...
    @discardableResult
    @available(*, deprecated, message: "the sync version of `neverTo` does not work in async contexts. Use the async version with the same name as a drop-in replacement")
    ...
    @discardableResult
    @available(*, deprecated, message: "the sync version of `toAlways` does not work in async contexts. Use the async version with the same name as a drop-in replacement")
    ...
    @discardableResult
    @available(*, deprecated, message: "the sync version of `alwaysTo` does not work in async contexts. Use the async version with the same name as a drop-in replacement")
